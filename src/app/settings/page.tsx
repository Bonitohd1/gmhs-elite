...
export default function SettingsPage() {
  ...
  function replayTour() {
    ...
    alert("Tour sẽ hiện lại khi bạn quay về Dashboard.");
    ...
    <div className="min-h-screen">
      ...
      <main className="lg:ml-60 p-4 sm:p-6 lg:p-8">
        ...
        <div className="card mb-4">
          ...
          <button onClick={replayTour} className="btn-ghost block w-full text-center mb-2">👋 Xem lại Onboarding Tour</button>
